  ...
  return (
    <div id="home" className="w-full h-screen text-center">
        ...
        <div className="uppercase text-sm tracking-widest text-gray-600">
            ...
            <p className="py-4 text-gray-600 max-w-[70%] m-auto"> I am a frontend developer who specializes in building seamless digital user experiences. I recenlty completed a certification for Fullstack and found myself immersed in Front-End web developement. In the last 7 months my skills have quickly flourished.</p>
